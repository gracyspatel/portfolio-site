  ...
  return (
    <div className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="bg-[#efefef] rounded-full py-1 px-1 hidden lg:flex lg:gap-x-2">
            <Link href="/" className="text-sm/6 py-1 px-6 rounded-full flex items-center justify-center gap-2 font-semibold text-gray-900 hover:bg-[#ffffff]"> <Image
                  // className="dark:invert"
                  src="/user-solid.svg"
                  alt="Home Link"
                  width={14}
                ...
                />
                Home</Link>
            <Link href="/about" className="text-sm/6 py-1 px-6 rounded-full flex items-center justify-center gap-2 font-semibold text-gray-900 hover:bg-[#ffffff]"> <Image
                  // className="dark:invert"
                  src="/user-solid.svg"
                  alt="About Link"
                  width={14}
          ...
          <div className="hidden lg:flex lg:gap-x-6 lg:flex-1 lg:justify-end">
            <Link href="#" className="text-sm/6 flex items-center justify-center gap-2 font-semibold text-gray-900"> <Image
                  // className="dark:invert"
